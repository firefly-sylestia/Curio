...
fun CurioNavHost(
    ...
    if (tourStep != null && routePrefix == tourStep.routePrefix) {
        ...
        // v236 — the dock joins the liquid-glass family: when the pills
        // experiment is on it refracts the page behind it (it is a SIBLING
        // overlay of the capture Box — the safe architecture), and both
        // buttons carry the touch press-blob.
        ...
        Surface(
            modifier = Modifier
                ...
                .then(
                    if (tourGlass) Modifier.liquidGlassCapsule(tourContainer)
                    else Modifier
                ),
