...
object TopicJsonLoader {
    ...
    private suspend fun parseAndCache(id: CategoryId): List<CurioTopic> {
        ...
        // Room is populated explicitly by TopicRepository during the
        // controlled catalog import/update path. Do not start a delete/insert
        // transaction from a screen-triggered JSON load; that competed with
        // the first render and caused repeated database work.
        return parsed
    }
