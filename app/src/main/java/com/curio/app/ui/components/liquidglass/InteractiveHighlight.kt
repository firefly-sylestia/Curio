 ...
 * ui/main/glass/InteractiveHighlight.kt — GPL-2.0-or-later.
 * The touch-following specular sheen: a RuntimeShader radial glow that
 * tracks the finger while pressed and springs back to its origin on
 * release (API 33+ only — callers gate creation on SDK_INT).
 */
